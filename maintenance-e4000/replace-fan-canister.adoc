...
---
= Remplacez un boîtier de ventilateur dans un tiroir E4000 à 60 disques
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. Lorsque vous trouvez l'étagère avec une icône rouge, sélectionnez soit le boîtier du ventilateur, soit l'icône rouge du ventilateur.
