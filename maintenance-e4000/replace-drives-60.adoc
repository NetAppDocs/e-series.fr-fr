...
---
= Remplacez un disque dans un châssis E4000 à 60 disques
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez remplacer un disque du système E4000 par un tiroir de 60 disques.
...
Cette procédure s'applique aux étagères de lecteurs DCM, DCM2 et DCM3.
...
+
.. Sélectionnez le menu : Hardware[Drives].
