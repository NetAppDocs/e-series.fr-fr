...
summary:  
---
= Remplacez le contrôleur dans un système de stockage E4000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
... Sélectionnez le menu : Hardware [Controller and components].
...
.. Sélectionnez *icône ellipse › Redistribuer les volumes*.
