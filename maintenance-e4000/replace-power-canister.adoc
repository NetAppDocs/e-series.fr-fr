...
---
= Remplacez un bloc d'alimentation dans un châssis E4000 à 60 disques
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.. Lorsque vous trouvez l'étagère avec une icône rouge, sélectionnez soit la cartouche d'alimentation, soit l'icône d'alimentation rouge.
