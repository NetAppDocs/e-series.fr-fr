...
... Si le graphique affiche les lecteurs, sélectionnez *Controller & Components* pour afficher les contrôleurs
...
+
.. Sélectionnez *Stockage › Volumes*. Depuis la page *Tous les volumes*, vérifiez que les volumes sont attribués à leurs propriétaires préférés. Sélectionnez *Plus › Modifier la propriété* pour afficher les propriétaires des volumes
