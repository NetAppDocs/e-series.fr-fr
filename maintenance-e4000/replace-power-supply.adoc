...
---
= Remplacer une alimentation dans un système de stockage E4000
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.. Lorsque vous trouvez l'étagère avec une icône rouge, sélectionnez l'une des alimentations électriques.
