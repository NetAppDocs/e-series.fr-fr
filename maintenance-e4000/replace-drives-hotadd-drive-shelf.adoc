...
---
= Ajoutez à chaud un châssis de disque E4000 avec modules IOM12 ou IOM12B
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Cette procédure s'applique à l'ajout à chaud d'un tiroir disque DE212C, DE224C ou DE460C à un tiroir contrôleur E4000.
...
+
image::../media/sam1130_ss_hardware_iom_icon.gif[Icône IOM]
...
+
image::../media/hot_e4000_cabling_1.png[Câblez le tiroir de lecteur]

. Dans SANtricity System Manager, sélectionnez le menu : Hardware [Controllers and components].
+
...
. Dans SANtricity System Manager, sélectionnez le menu : Matériel [Contrôleurs et composants], puis faites défiler vers le bas, si nécessaire, pour afficher le nouveau tiroir de disque ajouté.
