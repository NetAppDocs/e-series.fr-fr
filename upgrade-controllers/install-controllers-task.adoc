...
--
Pour plus d'informations sur l'installation des nouveaux contrôleurs EF80 et EF50, consultez link:https://docs.netapp.com/us-en/e-series/maintenance-ef50-ef80/controller-replace-move-hardware.html#step-7-install-the-controller["EF50 et EF80 - Étape 7 : Installez le contrôleur"^].
