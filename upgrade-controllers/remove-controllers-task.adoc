...
[role="tabbed-block"]
====
.Modèles de contrôleurs EF80 et EF50
--
Pour plus d'informations sur le retrait des contrôleurs des systèmes de stockage EF80 et EF50, voir link:https://docs.netapp.com/us-en/e-series/maintenance-ef50-ef80/controller-replace-move-hardware.html#step-1-remove-the-controller["EF50 et EF80 - Étape 1 : Retirez le contrôleur"^].

--
.Autres modèles de contrôleurs E-Series
--
[discrete]
=== Modèles de contrôleurs E4000, E2800 et E5700
...
[discrete]
=== Modèles de contrôleurs EF600 et EF300

Retirez le boîtier du contrôleur afin de pouvoir le remplacer par un neuf.
...
+
Comme vous devez retirer le HIC de l'ancien boîtier de contrôleur, vous devez également retirer les SFP des ports HIC. Lorsque vous rebranchez les câbles, vous pouvez déplacer ces SFP vers le nouveau boîtier de contrôleur.
