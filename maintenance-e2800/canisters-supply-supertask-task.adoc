...
---
= Remplacez le bloc d'alimentation sur un châssis E2800 à 12 ou 24 disques
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.. Consultez les icônes d'alimentation image:../media/sam1130_ss_hardware_power_icon_maint-e2800.gif["Icône d'alimentation"] et de ventilateur image:../media/sam1130_ss_hardware_fan_icon_maint-e2800.gif["Icône de ventilateur"] à droite des listes déroulantes *Étagère* pour déterminer quelle étagère présente une alimentation défectueuse.
+
