...
---
= Remplacez le boîtier du ventilateur dans une étagère E2800 à 60 disques
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/28_dwg_e2860_de460c_single_fan_canister_with_orange_tab_callout_maint-e2800.gif[Languette de déverrouillage du boîtier du ventilateur]
