...
---
= Effectuez la conversion du protocole hôte pour une baie E2800
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
. Cliquez sur le commutateur et sélectionnez *Configurer les ports iSCSI*.
...
.. Sélectionnez l'hôte auquel le port sera associé et cliquez sur *Afficher/Modifier les paramètres*.
+
La boîte de dialogue Modifier les paramètres de l'hôte s'affiche.
