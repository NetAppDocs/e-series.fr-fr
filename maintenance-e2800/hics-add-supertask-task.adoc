...
---
= Ajoutez une carte d'interface d'hôte à une baie E2800
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
+
image::../media/28_dwg_e2824_remove_controller_canister_maint-e2800.gif[Retirer le boîtier du contrôleur du shelf]
...
+
image::../media/28_dwg_e2860_add_controller_canister_maint-e2800.gif['Retirer le boîtier du contrôleur de la tablette']
...
+
image::../media/28_dwg_e2800_hic_thumbscrews_maint-e2800.gif[Installez HIC sur la carte contrôleur]
...
+
image::../media/28_dwg_e2800_hic_faceplace_screws_maint-e2800.gif[Installez le cache sur le contrôleur]
...
+
La figure suivante est un exemple de tiroir contrôleur E2860 : image:../media/28_dwg_e2860_add_controller_canister_maint-e2800.gif["Réinstallez le boîtier du contrôleur"]
