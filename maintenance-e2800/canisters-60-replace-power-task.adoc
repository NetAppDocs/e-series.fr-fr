...
---
= Remplacez le bloc d'alimentation dans une étagère E2800 à 60 disques
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
+
.. Sélectionnez le menu : Hardware[Controllers and components] dans le panneau de gauche.
...
+
image::../media/28_dwg_e2860_de460c_psu_w_callouts_maint-e2800.gif[LED du boîtier d'alimentation]
