...
* Pour les configurations recto verso, reportez-vous à la section  controller offline (duplex).
* Pour les configurations recto, voir  down the controller shelf (simplex).
