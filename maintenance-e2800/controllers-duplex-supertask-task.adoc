...
---
= Remplacez un contrôleur dans une configuration duplex E2800
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
+
... Sélectionnez *matériel*.
... Si le graphique affiche les disques, sélectionnez *Afficher l’arrière du châssis* pour afficher les contrôleurs
