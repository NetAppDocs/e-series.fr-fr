...
+
** Si l'alimentation est éteinte, vous n'avez pas besoin d'exécuter la commande CLI. Accédez à  2: Remove cable chains.
...
+
** Si la commande réussit, il n'est pas nécessaire d'arrêter l'activité d'E/S de l'hôte. Tous les disques du tiroir se trouvent dans des pools ou des groupes de volumes avec protection contre la perte de tiroirs. Accédez à  2: Remove cable chains.
+
...
+
image::../media/trafford_cable_rail_1_maint-e5700.gif[rail de câble trafford 1 prise e5700]

+
*(1)* _connecteur vertical (connecté au fond de panier central)_
...
+
image::../media/trafford_cable_rail_3_maint-e5700.gif[rail de câble trafford 3 maint e5700]
...
+
image::../media/trafford_cable_rail_2_maint-e5700.gif[rail de câbles trafford 2 maint. e5700]
...
+
image::../media/92_pht_de6600_drive_drawer_release_lever_maint-e5700.gif[92 pht de6600 levier de déverrouillage du tiroir disque maint e5700]
...
+
image::../media/92_pht_de6600_lock_out_tumbler_detail_maint-e5700.gif[92 pht de6600 verrouillage du tubeur à détail tubeur maint e5700]
...
+
image::../media/2860_dwg_both_guide_rails_maint-e5700.gif[2860 dwg des deux rails de guidage maint. e5700]
