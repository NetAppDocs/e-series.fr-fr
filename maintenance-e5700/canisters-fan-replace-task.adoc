...
---
= Remplacez le boîtier du ventilateur dans un châssis E5700 à 60 disques
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.. Regardez l'icône de ventilateur à image:../media/sam1130_ss_hardware_fan_icon_maint-e5700.gif["Icône de ventilateur"]droite des listes déroulantes *Shelf* pour déterminer quelle étagère est dotée du boîtier de ventilateur défectueux.
+
...
+
image::../media/28_dwg_e2860_de460c_single_fan_canister_with_led_callout_maint-e5700.gif[LED d'avertissement]
...
+
image::../media/28_dwg_e2860_de460c_single_fan_canister_with_orange_tab_callout_maint-e5700.gif[Appuyez sur la languette orange pour libérer la poignée du boîtier du ventilateur]
...
+
image::../media/28_dwg_e2860_de460c_fan_canister_handle_with_callout_maint-e5700.gif[Utilisez la poignée pour extraire le boîtier du ventilateur]
