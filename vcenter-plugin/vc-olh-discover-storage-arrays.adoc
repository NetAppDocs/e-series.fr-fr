...
.Étapes
. Si la boîte de dialogue « Résoudre les certificats auto-signés » s’ouvre, consultez les informations affichées pour les certificats non approuvés. Pour plus d’informations, vous pouvez également cliquer sur les points de suspension à l’extrémité du tableau et sélectionner *Afficher* dans le menu contextuel.
. Effectuez l'une des opérations suivantes :
+
