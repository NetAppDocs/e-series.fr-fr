...
---
= Plateaux pris en charge dans l'armoire E-Series 3040 40U
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez installer les plateaux de contrôleur-disque suivants et les plateaux de disque d'extension dans l'armoire E-Series 3040 40U.

Si vos plateaux de contrôleur-disque ou de plateaux de disque d'extension ne sont pas répertoriés ci-dessous, consultez  https://hwu.netapp.com["NetApp Hardware Universe"^] pour vérifier si vos plateaux de contrôleur-disque ou de plateaux de disque d'extension sont pris en charge.
