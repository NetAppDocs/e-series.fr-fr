...
---
= Découvrez le câblage des systèmes de stockage E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
|===
Pour plus d'informations sur le câblage permettant de prendre en charge les fonctions de mise en miroir, consultez le https://www.netapp.com/pdf.html?item=/media/19405-tr-4839.pdf["Guide de déploiement et description des fonctionnalités de mise en miroir synchrone et asynchrone"^].
