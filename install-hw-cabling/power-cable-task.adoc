...
---
= Alimentation par câble pour votre système de stockage E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
. Mettez sous tension les deux alimentations.
+

NOTE: Selon votre système de stockage, les alimentations disposent d'interrupteurs ou il n'y a pas d'interrupteurs et vous devez connecter les câbles d'alimentation pour les mettre sous tension.
