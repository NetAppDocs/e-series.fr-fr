...
---
= Câblage hôte pour les contrôleurs et commutateurs E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Les informations suivantes ne s'appliquent pas à tous les systèmes de stockage. Pour le câblage d'interface d'hôte spécifique à votre système de stockage, consultez link:../getting-started/getup-run-concept.html["Démarrage rapide de la gamme E-Series"^] et cliquez sur le lien correspondant à votre système de stockage.
