...
Cette procédure s'applique à l'ajout à chaud d'un tiroir disque DE212C, DE224C ou DE460C à une baie E2800, E2800B, EF280, E5700, E5700B, Tiroir contrôleur EF570 ou EF300.
...
Sélectionnez l'une des options suivantes, selon que vous câbler un système de stockage E2800 et E5700 ou un système de stockage EF300.
...
=== Option 1 : connectez le tiroir disque pour les systèmes E2800 et E5700
...
=== Option 2 : connexion du tiroir disque pour EF300
