...
Pour installer le matériel de la série E, consultez les instructions d'installation et de configuration de votre baie de stockage et de votre type d'étagère (le cas échéant) :

[role="quick-margin-list"]
* link:../install-hw-ef50-ef80/install-workflow.html["Système de stockage EF50 ou EF80"^]
...
[role="quick-margin-list"]
* https://docs.netapp.com/us-en/e-series-santricity/system-manager/index.html["Aide en ligne de SANtricity System Manager pour la version 12.0x"^]
* https://docs.netapp.com/us-en/e-series-santricity-119/system-manager/index.html["Aide en ligne de SANtricity System Manager pour 11.9x"^]
