...
---
= Contenu inclus dans cette documentation E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Des interfaces et systèmes d'exploitation supplémentaires peuvent être pris en charge. Pour plus d'informations, contactez le support technique.
 ...
 a| 
Ce site ne contient _pas_ d'informations concernant les versions _antérieures_ à la version logicielle 11.50 ou à la version micrologicielle 8.50. Pour les versions antérieures, accédez à la page  https://docs.netapp.com/us-en/e-series-santricity/early-versions.html#software-documentation-for-earlier-releases["Documentation E-Series et SANtricity pour les versions antérieures"^].
