...
---
= Découvrez le logiciel SANtricity pour la série E
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
Unified Manager est un logiciel web utilisé pour gérer l'ensemble de votre domaine. Depuis une vue centralisée, vous pouvez voir l'état de toutes les baies E-Series et EF-Series récentes, telles que les EF50, EF80, E4000, EF300, EF600, EF300C et EF600C. Vous pouvez également effectuer des opérations par lots sur les baies de stockage sélectionnées.
...
L'interface en ligne de commandes (CLI) est une application logicielle qui permet de configurer et de surveiller les baies de stockage. À l'aide de la CLI, vous pouvez exécuter des commandes à partir d'une invite de commandes du système d'exploitation, telle que l' `DOS C:`invite de commandes, un chemin du système d'exploitation Linux ou un chemin du système d'exploitation Solaris.
