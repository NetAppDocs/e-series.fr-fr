...
image:../media/drw_e4012_direct_topology_ieops-2156.svg["E4012 topologie directe, largeur=1000 px"]
...
image:../media/drw_e4012_fabric_topology_ieops-2157.svg["Topologie de structure E4012, largeur=1000 px"]
