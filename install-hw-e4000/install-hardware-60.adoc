...
---
= Installez le matériel pour un système de stockage E4060
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
CAUTION: Une étagère vide pèse environ 134 lb (61 kg). Un monte-charge ou quatre personnes utilisant des poignées de levage sont nécessaires pour déplacer une étagère vide en toute sécurité.
