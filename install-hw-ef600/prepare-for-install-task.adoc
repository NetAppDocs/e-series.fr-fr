...
---
= Préparez-vous à installer votre système de stockage EF300 ou EF600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
|===
+
Le tableau ci-dessous répertorie les types de câbles que vous pourriez recevoir. Si vous recevez un câble qui n'y figure pas, consultez link:https://hwu.netapp.com["NetApp Hardware Universe"^] pour le localiser et identifier son utilisation.
