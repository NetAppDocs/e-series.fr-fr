...
---
= Vérifiez l'accès au stockage sur un hôte Windows dans le système de stockage E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
.. Dans le SANtricity System Manager, accédez à *Stockage* > *Volumes*, puis sélectionnez l’icône *ellipsis* > *Changer la propriété du volume*.
