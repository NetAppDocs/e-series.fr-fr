...
summary: 'Vous pouvez créer une partition sur le périphérique multichemin, éventuellement créer un système de fichiers sur l"espace de noms, et monter la partition.' 
---
= Création de systèmes de fichiers dans E-Series - Linux RHEL 7 et SLES 12 (NVMe over FC)
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Pour RHEL 7 et SLES 12, vous créez un système de fichiers sur le périphérique dm souhaité et montez le système de fichiers.
