...
---
= Créer des systèmes de fichiers sur des volumes E-Series pour les hôtes SLES 12 NVMe over FC
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Pour SLES 12, vous créez un système de fichiers sur le périphérique DM souhaité et montez le système de fichiers.
