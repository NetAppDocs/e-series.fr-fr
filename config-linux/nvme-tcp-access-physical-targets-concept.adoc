...
---
= Comment les hôtes Linux accèdent aux volumes NVMe sur les cibles E-Series via TCP
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Et la suite ?
Avec les E/S fonctionnant vers les périphériques NVMe, link:nvme-tcp-create-filesystems-sles-15-task.html["créer les systèmes de fichiers"].
