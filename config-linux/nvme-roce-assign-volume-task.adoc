...
---
= Attribuez un volume E-Series avec SANtricity System Manager pour NVMe over RoCE
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.Et la suite ?
Après avoir attribué un volume, link:nvme-roce-display-volumes-visible-host-task.html["afficher les volumes visibles à l'hôte"].
