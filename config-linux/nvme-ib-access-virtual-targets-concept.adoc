...
summary: 'Configurez les E/S dirigées vers le périphérique cible en fonction de votre version de SLES (SUSE Linux version).' 
---
= Comment le système de stockage E-Series achemine les E/S vers des cibles NVMe virtuelles sous Linux via InfiniBand
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
