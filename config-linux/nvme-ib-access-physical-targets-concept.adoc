...
summary: 'Vous pouvez configurer les E/S dirigées vers le périphérique cible en fonction de votre version de SLES (SUSE Linux version).' 
---
= Comment le système de stockage E-Series achemine les E/S vers les cibles NVMe physiques sous Linux via InfiniBand
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Cela ne fonctionnera plus sur RHEL 10. Il fonctionne sur RHEL 9 et versions antérieures, ainsi que sur SLES 16 et versions antérieures.
