...
---
= Configurer les connexions RoCE du système de stockage E-Series pour les hôtes Linux
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.Et la suite ?
Après avoir configuré les paramètres du port NVMe sur RoCE, link:nvme-roce-discover-connect-storage-host-task.html["découvrir et connecter le stockage sur l'hôte"].
