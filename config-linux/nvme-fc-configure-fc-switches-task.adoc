...
summary: 'La configuration (segmentation) des commutateurs Fibre Channel (FC) permet aux hôtes de se connecter à la baie de stockage et de limiter le nombre de chemins. Vous pouvez segmenter les commutateurs à l"aide de l"interface de gestion.' 
---
= Configurer les commutateurs FC pour les hôtes Linux NVMe over FC du système de stockage E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
