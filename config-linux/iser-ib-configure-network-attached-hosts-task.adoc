...
---
= Configurer les connexions réseau pour les hôtes Linux E-Series à l'aide d'iSER sur IB
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
+
*Red Hat Enterprise Linux 8, 9 et 10 (RHEL 8, RHEL 9 et RHEL 10)*
...
----
+
*SUSE Linux Enterprise Server 12, 15 et 16 (SLES 12, SLES 15 et SLES 16)*
...
iscsiadm -m session
----
.. Vérifiez l'état de la session iscsi sur la baie. Dans SANtricity System Manager, accédez à *Paramètres* > *Système* > *Afficher/Terminer les sessions iSCSI*.
