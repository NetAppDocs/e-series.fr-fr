...
---
= Afficher les volumes visibles pour un hôte Linux NVMe over TCP E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
----
.Et la suite ?
Après avoir visualisé les volumes visibles, link:nvme-tcp-setup-failover-host-task.html["Configurer le basculement sur l'hôte"].
