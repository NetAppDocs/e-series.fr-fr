...
.Avant de commencer
Vous devez utiliser le dernier système d’exploitation compatible RHEL 8, RHEL 9, SUSE Linux Enterprise Server 12 ou 15 Service Pack. Consultez le https://mysupport.netapp.com/matrix["Matrice d'interopérabilité NetApp"^] pour une liste complète des dernières exigences.
