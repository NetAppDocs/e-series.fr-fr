...
---
= Configurez un initiateur NVMe sur InfiniBand sur un hôte Linux E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Avant de commencer
Vous devez utiliser la dernière version compatible du système d'exploitation RHEL 8, RHEL 9, RHEL 10, SLES 12, SLES 15 ou SLES 16 Service Pack. Voir le https://mysupport.netapp.com/matrix["Matrice d'interopérabilité NetApp"^] pour obtenir la liste complète des dernières exigences.

.Étapes
. Installer les packages rdma, nvme-cli et infiniband :
+
*SLES 12, SLES 15 ou SLES 16*
