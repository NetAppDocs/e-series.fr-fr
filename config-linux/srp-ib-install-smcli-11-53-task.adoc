...
summary: 'Lorsque vous installez le logiciel SANtricity Storage Manager sur votre station de gestion, une interface graphique (GUI) et une ligne de commandes (CLI) sont installées par défaut. Ces instructions supposent que vous installerez l"interface graphique SANtricity Storage Manager sur une station de gestion et non sur l"hôte d"E/S.' 
---
= Installer SANtricity Storage Manager pour SMcli sur les hôtes Linux E-Series
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
