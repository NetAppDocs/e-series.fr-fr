...
---
= Créez des partitions et des systèmes de fichiers sur des hôtes Linux E-Series à l'aide d'iSER sur IB
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
NOTE: Vous pouvez également récupérer ces résultats via le `multipath -ll` commande.
