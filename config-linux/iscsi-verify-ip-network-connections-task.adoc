...
summary: 'Vous pouvez vérifier les connexions réseau IP à l"aide des tests ping afin de vous assurer que l"hôte et la matrice sont en mesure de communiquer.' 
---
= Vérifiez les connexions réseau IP sur les hôtes Linux E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
