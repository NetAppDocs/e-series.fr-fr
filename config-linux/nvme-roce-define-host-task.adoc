...
---
= Créer un hôte E-Series pour NVMe over RoCE sous Linux
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.Et la suite ?
Après avoir créé l'hôte, link:nvme-roce-assign-volume-task.html["Attribuer un volume via SANtricity System Manager"].
