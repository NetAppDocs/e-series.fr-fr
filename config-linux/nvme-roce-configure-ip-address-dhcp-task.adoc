...
---
= Configurer les adresses IP à l'aide de DHCP pour NVMe over RoCE dans le système de stockage E-Series
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
.Et la suite ?
Après avoir configuré les adresses IP à l'aide du DHCP, link:nvme-roce-access-sam-setup-wizard-task.html["Configurez votre stockage à l'aide de SANtricity System Manager"].
