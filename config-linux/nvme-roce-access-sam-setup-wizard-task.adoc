...
---
= Configurez le système de stockage E-Series à l'aide de SANtricity System Manager pour RoCE
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
.Et la suite ?
Après avoir configuré le stockage dans SANtricity System Manager, link:nvme-roce-configure-switch-task.html["configurer les commutateurs"].
