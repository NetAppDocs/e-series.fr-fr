...
summary: Pour SLES 12, vous créez un système de fichiers sur l’espace de noms et montez le système de fichiers. 
---
= Créer des systèmes de fichiers sur des hôtes Linux SLES 12 du système de stockage E-Series avec NVMe sur InfiniBand
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Pour SLES 12, vous créez un système de fichiers sur l’espace de noms et montez le système de fichiers.
