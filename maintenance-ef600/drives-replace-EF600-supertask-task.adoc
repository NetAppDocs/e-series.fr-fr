...
---
= Remplacer un disque dans une baie EF600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez remplacer un disque dans une baie EF600 ou EF600C.
...
+
image::../media/ef624_2.png[Retirez le disque du shelf]
