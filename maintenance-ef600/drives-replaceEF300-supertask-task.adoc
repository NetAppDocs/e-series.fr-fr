...
---
= Remplacez le lecteur dans une matrice EF300
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Vous pouvez remplacer un lecteur dans une matrice EF300.

L' EF300 prend en charge l'extension SAS avec des tiroirs de 24 et 60 disques. La procédure à suivre dépend du fait que vous disposez d'un tiroir de 24 disques ou de 60 disques :
