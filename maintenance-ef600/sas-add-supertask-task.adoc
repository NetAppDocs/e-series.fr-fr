...
---
= Ajoutez une carte d'extension SAS à un contrôleur EF300 ou EF600
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
. Depuis la page d'accueil de SANtricity System Manager, sélectionnez menu:Storage[Operations in Progress]. Attendez la fin de toutes les opérations avant de passer à l'étape suivante.
