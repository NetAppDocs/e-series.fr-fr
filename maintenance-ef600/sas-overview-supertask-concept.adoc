...
---
= Exigences de remplacement de la carte d'extension SAS pour EF300 et EF600
:allow-uri-read: 
:icons: font
:imagesdir: ../media/
...
* Pour les contrôleurs EF300 et EF600, la carte d'extension SAS doit être installée dans le port 1 pour permettre l'extension du plateau de disque.
