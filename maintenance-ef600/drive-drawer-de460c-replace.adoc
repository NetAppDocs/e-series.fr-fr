...
summary: 'Pour les systèmes de stockage EF300 et EF600, vous pouvez remplacer un tiroir de disque dans une baie de disques d"extension DE460C lorsque la baie de disques est en ligne ou hors ligne.' 
---
= Remplacez le tiroir du lecteur dans un DE460C - EF300 et EF600
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
[role="lead"]
Pour les systèmes de stockage EF300 et EF600, vous pouvez remplacer un tiroir de disque dans une baie de disques d'extension DE460C lorsque la baie de disques est en ligne ou hors ligne.
