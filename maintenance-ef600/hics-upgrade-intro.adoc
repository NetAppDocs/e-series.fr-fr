...
---
= Mettez à niveau le HIC dans un système de stockage EF300 ou EF600
:allow-uri-read: 
:experimental: 
:icons: font
:imagesdir: ../media/
...
. Dans SANtricity System Manager, sélectionnez menu:Storage[Operations in Progress]. Attendez la fin de toutes les opérations avant de passer à l’étape suivante.
